...
```bash
wget -O $HOME/.mineplex-chain/config/genesis.json <https://snapshot.warlord44.host/crossfi-testnet/genesis.json>
wget -O $HOME/.mineplex-chain/config/addrbook.json <https://snapshot.warlord44.host/crossfi-testnet/addrbook.json>
```
...
```bash
SEEDS=""
$PEERS"de1e9221a35de41e08653ef0aca405c1f2ad500e@crossfi-testnet-peer.warlord44.host:19656"
...
## Check sync status
If your node is fully synced, the output will print **false**
...
You can configure **identity**, **website** and **details**
